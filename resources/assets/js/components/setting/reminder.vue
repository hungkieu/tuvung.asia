<template>
  <div class="reminder uk-card-default">
    <form>
      ...
      <p class="w-100">Vào lúc
        <input name="time" type="time" class="uk-input uk-form-small w-25 mx-2" v-model="plan.time"> hằng ngày
      </p>
...
export default {
  ...
  methods: {
    get_data() {
      axios
        .get("/c/training_plans/" + this.user.id)
        .then(res => {
