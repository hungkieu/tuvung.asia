  ...
  <div class="profile-detail uk-card-default">
    <div class="profile-info">
      ...
      <form class="uk-grid-small" uk-grid id="form_edit_user">
        ...
        <div class="uk-width-1-1">
          <button
            class="uk-button uk-text-uppercase uk-button-primary px-4 mt-4 rounded font-weight-bold"
            @click="save"
          >Lưu</button>
        </div>
      </form>
...
export default {
  ...
  methods: {
    ...
    save(e) {
      ...
      axios
        .post("/users/update/" + this.user.id, this.user)
        .then(function(res) {
