      ...
      <div class="uk-margin-top" uk-grid>
        <div class="uk-width-1-3">
          ...
          <form id="form_create_vocab" class="uk-form-stacked">
            ...
            <div>
              <label class="uk-form-label bold">Tiếng Anh
                <span v-if="!validate.en">(
                  <i class="uk-text-meta uk-text-warning">* Không được để trống</i> )
                </span>
              </label>
              <div class="uk-form-controls">
                <input
                  class="uk-input"
                  v-model="vocabulary.en"
                  type="text"
                  name="en"
                  required
                  id="en"
            ...
            <div>
              <label class="uk-form-label bold mt-3">Tiếng Việt
                <span v-if="!validate.vi">(
                  <i class="uk-text-meta uk-text-warning">* Không được để trống</i> )
                </span>
              </label>
              <div class="uk-form-controls">
            ...
            <div>
              <label class="uk-form-label bold mt-3">Loại từ
                <span v-if="!validate.type">(
                  <i class="uk-text-meta uk-text-warning">* Bạn chưa chọn loại từ</i> )
                </span>
              </label>
            ...
            <div>
              <label class="uk-form-label bold mt-3">Hình ảnh</label>
              <div>
                <input
                  type="file"
                  id="file"
                ...
                <label for="file" class="preview" v-else="preview">Upload hình ảnh</label>
              </div>
            </div>
            <div class="uk-margin">
...
export default {
  ...
  methods: {
    ...
    validated() {
      if (this.vocabulary.en.trim().length == 0) this.validate.en = false;
      else this.validate.en = true;
      if (this.vocabulary.vi.trim().length == 0) this.validate.vi = false;
      else this.validate.vi = true;
      if (this.vocabulary.type.length == 0) this.validate.type = false;
      else this.validate.type = true;
